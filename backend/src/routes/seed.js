...
router.post("/seed-messages", async (req, res) => {
  try {
    ...
    const chatRoom = Message.generateChatRoom(
      currentUser._id,
      jamesWilliams._id
    );
    ...
    const mockMessages = [
      ...
      },
      {
        ...
        receiver: currentUser._id,
        content:
          "Today we planned for outing. You need to come and pick me after my work",
        chatRoom,
        messageType: "text",
      },
      {
        ...
        content:
          "Sure. I'm in taxi right now. Will call you once I reach the office",
        chatRoom,
        messageType: "text",
      },
      {
    ...
    if (createdMessages.length > 0) {
      await conversation.updateLastMessage(
        createdMessages[createdMessages.length - 1]._id
      );
    }
